...
const SignUp = ({ setCurrentPage }) => {
  ...
  return <div className="w-full p-6 flex flex-col justify-center">
    <h3 className="text-lg font-semibold text-indigo-950">Create an Account</h3>
    <p className="text-sm text-slate-700 mt-[5px] mb-2">
      Join us today by entering your details below.</p>

    <form onSubmit={handleSignUp}>
        <div className="mt-4.5 mb-0">
